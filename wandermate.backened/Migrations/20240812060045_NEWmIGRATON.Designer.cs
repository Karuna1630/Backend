...
namespace wandermate.backened.Migrations
{
    ...
    [Migration("20240812060045_NEWmIGRATON")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "768ebf44-72ed-4906-9469-f3cf8e6377dc",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "be40c79f-ac82-4cc4-8454-6569cdad89f5",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("wandermate.backened.Models.Booking", b =>
                {
                    ...
                    b.HasOne("wandermate.backened.Models.Users", "user")
                        .WithMany("HotelBooking")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
